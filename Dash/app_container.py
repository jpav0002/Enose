                              ...
                              html.Div(className='six columns controls-1',
                                       children=[
                                           ...
                                           html.Div(className='div-for-dates',
                                            ...
                                            html.Div(className='GraduatedBar',
                                            children=[
                                                html.P('Odor Intensity'),
                                                daq.GraduatedBar(
                                                    id='Odor_Bar',
                                                    color={"gradient":True,"ranges":{"green":[0,5],"yellow":[5,9],"red":[9,10]}},
                                                    showCurrentValue=True,
                                                    value=df['Intensity'].iloc[-1],
                                                    ),
                                            ]),
                                       ]),
...
def update_graphs(env_var, sensor_var, start, end):
    ...
    return figure_env, figure_sensor, filtered['Intensity'].iloc[-1]
