...
tic = time()
est = MLPRegressor(hidden_layer_sizes=(50,50), activation='relu', solver='lbfgs',
...
print(f"Prediccion DecisionTreeRegressor:  {regr_2.predict([[30.333714808880746,66.8264794893314,27.563723958333334,41.52182849823066]])}")
